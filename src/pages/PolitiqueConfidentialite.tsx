    ...
    <main className="container py-5" style={{ padding: "0 1.5rem" }}>
      <div className="gaming-document-container">
        <div style={{ marginBottom: "2rem" }}>
          <button className="btn-gaming btn-gaming-secondary" style={{ padding: "0.4rem 0.8rem", fontSize: "0.75rem" }} onClick={() => navigate("/cgu")}>
            &larr; Retour aux CGU
          </button>
        </div>
        ...
        <p>
          ...
          si elles sont inexactes ou incomplètes. Pour exercer ce droit, veuillez nous contacter.
        </p>
        ...
        <div className="text-center" style={{ marginTop: "2.5rem" }}>
          <button className="btn-gaming btn-gaming-secondary" onClick={() => navigate("/cgu")}>
            Retour aux CGU
          </button>
        </div>
      </div>
